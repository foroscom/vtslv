...
srcdir = ext/vtslv
topdir = /home/dan/.rvm/rubies/ruby-2.6.3/include/ruby-2.6.0
hdrdir = $(topdir)
arch_hdrdir = /home/dan/.rvm/rubies/ruby-2.6.3/include/ruby-2.6.0/x86_64-linux
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/home/dan/.rvm/rubies/ruby-2.6.3
...
INCFLAGS = -I. -I$(arch_hdrdir) -I$(hdrdir)/ruby/backward -I$(hdrdir) -I$(srcdir) -I/home/dan/.rvm/gems/ruby-2.6.3/gems/rice-4.0.2/include
DEFS     = 
CPPFLAGS =   $(DEFS) $(cppflags)
CXXFLAGS = $(CCDLFLAGS) $(cxxflags) -Wno-register -std=c++17 $(ARCH_FLAG)
...
install-so: $(DLLIB) $(TIMESTAMP_DIR)/.sitearchdir.-.vtslv.time
...
pre-install-rb-default:
	@$(NULLCMD)
$(TIMESTAMP_DIR)/.sitearchdir.-.vtslv.time:
...
$(TARGET_SO): $(OBJS) Makefile
	$(ECHO) linking shared-object vtslv/$(DLLIB)
	-$(Q)$(RM) $(@)
